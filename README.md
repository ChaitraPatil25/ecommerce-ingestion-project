...
Why This Project Matters:
	•	Shows backend and data engineering capabilities.
	•	Demonstrates Python and SQL proficiency.
	•	Follows clean, production-style project structuring.
	•	Solves a realistic business-side problem.